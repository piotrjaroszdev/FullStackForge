...
- Create Angular project with ng: `ng new fullstackforge.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`fullstackforge.client.esproj`).
